Contributing to PACTCoin Core
============================

The PACT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PACT Core project, and is not to be
confused with overall PACT Network Protocol consensus changes.

Whether a pull request is merged into PACT Core rests with the project merge
...
Patches that change PACT consensus rules are considerably more involved than
...
Where a patch set proposes to change the PACT consensus, it must have been
...
The project leader is the release manager for each PACT Core release.
