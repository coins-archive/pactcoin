...
In order to support loading of multiple wallets in pact-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pact.cpp.
...
Changes to pact.cpp
----------------------
pact.cpp is the entry point into pact-qt, and as such, will require some minor modifications to provide hooks for
