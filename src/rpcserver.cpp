...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PACT features */
        {"pact", "masternode", &masternode, true, true, false},
        {"pact", "listmasternodes", &listmasternodes, true, true, false},
        {"pact", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pact", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pact", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pact", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pact", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pact", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pact", "masternodedebug", &masternodedebug, true, true, false},
        {"pact", "startmasternode", &startmasternode, true, true, false},
        {"pact", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pact", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pact", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pact", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pact", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pact", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pact", "mnbudget", &mnbudget, true, true, false},
        {"pact", "preparebudget", &preparebudget, true, true, false},
        {"pact", "submitbudget", &submitbudget, true, true, false},
        {"pact", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pact", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pact", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pact", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pact", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pact", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pact", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pact", "checkbudgets", &checkbudgets, true, true, false},
        {"pact", "mnsync", &mnsync, true, true, false},
        {"pact", "spork", &spork, true, true, false},
        {"pact", "getpoolinfo", &getpoolinfo, true, true, false},
        {"pact", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzpactseed", &getzpactseed, false, false, true},
        {"zerocoin", "setzpactseed", &setzpactseed, false, false, true}
...
{
    return "> pact-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12877/\n";
}
