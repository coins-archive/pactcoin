                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PACT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PACT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pact: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPACT"));
...
//    tabGroup->addAction(proposalAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PACT Core"), this);
    aboutAction->setStatusTip(tr("Show information about PACT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PACT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PACT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PACT addresses"));
    ...
    openAction->setStatusTip(tr("Open a PACT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PACT Core help message to get a list with possible PACT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PACT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PACT network", "", count));
}
...
{
    QString strTitle = tr("PACT Core"); // default title
