...
/* PACT GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PACT"
#define QAPP_ORG_DOMAIN "pact.org"
#define QAPP_APP_NAME_DEFAULT "PACT-Qt"
#define QAPP_APP_NAME_TESTNET "PACT-Qt-testnet"
