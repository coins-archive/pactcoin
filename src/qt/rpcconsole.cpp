                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzpactPathCustom = GetArg("-zpactbackuppath", "");
    ...
    if(!strzpactPathCustom.empty()) {
        ui->wallet_customzpactbackuppath->setText(QString::fromStdString(strzpactPathCustom));
        ui->wallet_customzpactbackuppath_label->setVisible(true);
        ui->wallet_customzpactbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzpactPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PACT RPC console.") + "<br>" +
