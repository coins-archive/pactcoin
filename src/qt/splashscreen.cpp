...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("PACT Core");
    ...
    QString copyrightTextPACT = QChar(0xA9) + QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The PACT Core developers"));
    ...
    pixmap = pixmap.scaled(QSize(1200,1200), Qt::KeepAspectRatio,Qt::SmoothTransformation); 
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextPACT);
