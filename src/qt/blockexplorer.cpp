...
{
    std::string genesisblockhash = "0000014e48934142839aeec66658848a118cdf06460208ae03b6d064c80a2a66";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (pact.conf).");
            QMessageBox::warning(this, "PACT Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
