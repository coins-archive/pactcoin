...
RESOURCES += src/qt/pact.qrc src/qt/pact_locale.qrc

TRANSLATIONS += src/qt/locale/pact_bg.ts \
                src/qt/locale/pact_de.ts \
                src/qt/locale/pact_en.ts \
                src/qt/locale/pact_es.ts \
                src/qt/locale/pact_fi.ts \
                src/qt/locale/pact_fr.ts \
                src/qt/locale/pact_it.ts \
                src/qt/locale/pact_ja.ts \
                src/qt/locale/pact_pl.ts \
                src/qt/locale/pact_pt.ts \
                src/qt/locale/pact_ru.ts \
                src/qt/locale/pact_sk.ts \
                src/qt/locale/pact_sv.ts \
                src/qt/locale/pact_vi.ts \
                src/qt/locale/pact_zh_CN.ts \
                src/qt/locale/pact_zh_TW.ts
