...
#   c) node1 mines 32 blocks, so now node 0 has 60001pact, node 1 has 4250pact, node2 has none.
#   d) node0 sends 601 pact to node2, in two transactions (301 pact, then 300 pact).
